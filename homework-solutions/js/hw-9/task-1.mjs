...
// 4
let hasSalaryKey1stOption = "salary" in character ? {salary: character["salary"]} : false;
let hasSalaryKey2ndOption = Object.hasOwn(character, "salary") ? {salary: character["salary"]} : false;
